...
void tests(){
    ...
    test("test1_ashort.txt", "test1_bshort.txt", 30);
    test("test1_ashort.txt", "test1_bshort.txt", 300);

    printf("pliki srednie\n");

    test("test1_amed.txt", "test1_bmed.txt", 3);
    test("test1_amed.txt", "test1_bmed.txt", 30);
    test("test1_amed.txt", "test1_bmed.txt", 300);

    printf("pliki dlugie\n");

    test("test1_along.txt", "test1_blong.txt", 3);
    test("test1_along.txt", "test1_blong.txt", 30);
    test("test1_along.txt", "test1_blong.txt", 300);
}
